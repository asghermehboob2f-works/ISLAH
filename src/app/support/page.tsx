  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-12 space-y-10 font-sans">
      ...
      <div className="space-y-4">
        {faqs.map((faq, idx) => (
          <div key={idx} className="bg-[--bg-surface] border border-[--border] p-6 rounded-xl space-y-2 shadow-xs">
            <h3 className="text-sm font-bold text-[--text-primary] flex items-center gap-2">
              <HelpCircle className="w-4 h-4 text-blue-600 dark:text-blue-400" /> {faq.q}
            </h3>
