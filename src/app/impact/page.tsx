...
export default function ImpactPage() {
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-12 space-y-12 overflow-x-hidden font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-[--bg-surface] border border-[--border] p-6 rounded-xl text-center space-y-2 shadow-xs">
